...
class PAJ7620U2(object):
	def __init__(self, i2c, address=0x73):
	...
	def _read_u16(self,cmd):
		LSB = self._bus.readfrom_mem(self._address,cmd, 1)[0]
		MSB = self._bus.readfrom_mem(self._address,cmd+1, 1)[0]
		print(MSB,LSB)
		return (MSB	<< 8) + LSB
	def _write_byte(self,cmd,val):
		self._bus.writeto_mem(self._address,cmd,val)
	def check_gesture(self):
		Gesture_Data=self._read_u16(PAJ_INT_FLAG2)
